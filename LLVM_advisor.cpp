...
#include "../../../include/llvm/ADT/ilist.h"
#include "../../../include/llvm/IR/SymbolTableListTraits.h"
#include "../../../include/llvm/IR/IRBuilder.h"
#include "../../../include/llvm/IR/DebugLoc.h"
#include "../../../include/llvm/IR/GlobalValue.h"
#include "../../../include/llvm/IR/Metadata.h"
#include "../../../include/llvm/IR/Constants.h"
#include "../../../include/llvm/ADT/StringRef.h"
#include "../../../include/llvm/Transforms/Utils/Cloning.h"
#include <iostream>
...
namespace{
	...
	static cl::opt<int> BwStartLine("bw-start-line", cl::init(0), cl::Hidden,
		cl::desc("Start line number for memory bandwidth analysis"), cl::init(-1),cl::value_desc("line"));
	static cl::opt<int> BwEndLine("bw-end-line", cl::init(0), cl::Hidden,
		cl::desc("End line number for memory bandwidth analysis"), cl::init(-1),cl::value_desc("line"));
	...
	Value* ptr_fname=NULL;
		...
		Type* VoidTy = Type::getVoidTy(C); 
				...
				FunctionType *VoidFuncTy = FunctionType::get(VoidTy, /*isVarArg=*/false);
		...
		hookFunc1 = cast<Function>(M.getOrInsertFunction("print1", VoidFuncTy).getCallee());
		hookFunc2 = cast<Function>(M.getOrInsertFunction("print2", VoidFuncTy).getCallee());
		hookFunc3 = cast<Function>(M.getOrInsertFunction("print3", FunctionType::get(VoidTy, {Type::getInt32Ty(C)}, false)).getCallee());
		hookFunc4 = cast<Function>(M.getOrInsertFunction("print4", FunctionType::get(VoidTy, {Type::getInt64Ty(C)}, false)).getCallee());
		hookFuncEA = cast<Function>(M.getOrInsertFunction("printea", FunctionType::get(VoidTy, {Type::getInt8PtrTy(C), Type::getInt32Ty(C)}, false)).getCallee());
		hookFuncRetMain = cast<Function>(M.getOrInsertFunction("RetMain", VoidFuncTy).getCallee()); // Use VoidFuncTy here
		hookFuncString = cast<Function>(M.getOrInsertFunction("takeString", FunctionType::get(VoidTy, {Type::getInt8PtrTy(C), Type::getInt32Ty(C)}, false)).getCallee());
		hookFuncFCall = cast<Function>(M.getOrInsertFunction("callFunc", FunctionType::get(VoidTy, {Type::getInt8PtrTy(C), Type::getInt8PtrTy(C), Type::getInt32Ty(C), Type::getInt32Ty(C) , Type::getInt8PtrTy(C)}, false)).getCallee());
		hookFuncMallocEvent = cast<Function>(M.getOrInsertFunction("recordMEvent", FunctionType::get(VoidTy, {Type::getInt8PtrTy(C), Type::getInt64Ty(C),  Type::getInt32Ty(C),  Type::getInt32Ty(C)}, false)).getCallee());
		...
		//		errs() << op->getCalledFunction() -> getName().str() <<  "\n";
			...
			//	builder.CreateCall(hookString, args2);
					...
					//builder.CreateCall(hook3, builder.getInt32(l) );
									// NULL stackzone with height 0
					Value * p_stackzone = ConstantPointerNull::get(Type::getInt8PtrTy(C));
					builder.CreateCall(hookFCall, {ptr_caller, strPtr, builder.getInt32(l), builder.getInt32(cl), p_stackzone } );
				}
...
//// auto-detect CUDA kernels
		...
		{
			errs() << "I have no nvvm annotations\n";
			return false;
		}
...
//            	hookFunc1 = M.getOrInsertFunction(AF[0], VoidTy, (Type*)0);
		hookFunc1 = cast<Function>(M.getOrInsertFunction(AF[0], VoidTy, Type::getInt32Ty(C)).getCallee());
				hookFunc2 = cast<Function>(M.getOrInsertFunction(AF[1], VoidTy, (Type*)0).getCallee());
		hookFunc3 = cast<Function>(M.getOrInsertFunction(AF[2], VoidTy, Type::getInt32Ty(C), Type::getInt32Ty(C)).getCallee());
//		hookFunc4 = cast<Function>(M.getOrInsertFunction("print4", VoidTy, Type::getInt64Ty(C),  NULL).getCallee());
		hookFunc5 = cast<Function>(M.getOrInsertFunction(AF[3], VoidTy, Type::getInt8PtrTy(C), Type::getInt32Ty(C),  Type::getInt32Ty(C),  Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt8PtrTy(C)).getCallee());
//		hookFuncMain = cast<Function>(M.getOrInsertFunction("fini", VoidTy, (Type*)0).getCallee());
		hookFuncString = cast<Function>(M.getOrInsertFunction(AF[4], VoidTy, Type::getInt8PtrTy(C), Type::getInt32Ty(C)).getCallee());
//		Type::getFloatTy(M.getContext())  for float
		hook1= cast<Function>(hookFunc1); hook2= cast<Function>(hookFunc2); hook3= cast<Function>(hookFunc3); 
...
// basic block related instrumentation
	...
	Value* p_stackzone;
		...
		hookFunc3 = cast<Function>(M.getOrInsertFunction(AF[2], VoidTy, Type::getInt32Ty(C), Type::getInt32Ty(C)).getCallee());
		hookFuncString = cast<Function>(M.getOrInsertFunction(AF[4], VoidTy, Type::getInt8PtrTy(C), Type::getInt32Ty(C)).getCallee());
		hookFuncBB = cast<Function>(M.getOrInsertFunction("passBasicBlock", VoidTy, Type::getInt32Ty(C), Type::getInt32Ty(C),Type::getInt32Ty(C),Type::getInt32Ty(C), Type::getInt8PtrTy(C)).getCallee());
		//hookFuncBB = cast<Function>(M.getOrInsertFunction("passBasicBlock", VoidTy, Type::getInt8PtrTy(C), Type::getInt32Ty(C),Type::getInt32Ty(C),Type::getInt32Ty(C), Type::getInt8PtrTy(C),  NULL).getCallee());
...
////	
		...
		hookFuncString = cast<Function>(M.getOrInsertFunction(AF[4], VoidTy, Type::getInt8PtrTy(C), Type::getInt32Ty(C)).getCallee());
		hookFuncFCall = cast<Function>(M.getOrInsertFunction("callFunc", VoidTy, Type::getInt8PtrTy(C), Type::getInt8PtrTy(C), Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt8PtrTy(C)).getCallee());
                hookFCall = cast<Function>(hookFuncFCall);
		hookString = cast<Function> (hookFuncString);
		...
		/////
			...
			fc->dump();
 			...
 			ValueToValueMapTy VMap;
						...
						CloneFunctionInto(fc, &(*F) , VMap, llvm::CloneFunctionChangeType::LocalChangesOnly, Returns, "", codeinfo);
...
//	Value* buffer_stackHeight = NULL; //for global stack height on GPU
		...
		hookFuncCudaSync = cast<Function>(M.getOrInsertFunction("cudaDeviceSynchronize", Type::getInt32Ty(C)).getCallee());
				hookFuncAppendTrace = cast<Function>(M.getOrInsertFunction("appendTrace", VoidTy, Type::getInt8PtrTy(C), Type::getInt8PtrTy(C)).getCallee());
		hookFuncGetHandle = cast<Function>(M.getOrInsertFunction("getHandle", Type::getInt8PtrTy(C), Type::getInt32Ty(C)).getCallee());
		hookFuncGridDims = cast<Function>(M.getOrInsertFunction("gridDims", VoidTy, Type::getInt32Ty(C), Type::getInt32Ty(C), Type::getInt32Ty(C)).getCallee());
		hookFuncGridReset = cast<Function>(M.getOrInsertFunction("gridReset", VoidTy).getCallee());
		hookFuncGridGet = cast<Function>(M.getOrInsertFunction("gridGet", Type::getInt64Ty(C)).getCallee());
		hookAPI_malloc = cast<Function>(M.getOrInsertFunction("malloc", Type::getInt8PtrTy(C), Type::getInt64Ty(C)).getCallee());
		hookAPI_free = cast<Function>(M.getOrInsertFunction("free", VoidTy, Type::getInt8PtrTy(C)).getCallee());
...
////	
		...
		//	newiter->setName("b_stackHeight");
			...
			CloneFunctionInto(fc, &(*F) , VMap, llvm::CloneFunctionChangeType::LocalChangesOnly, Returns, "", codeinfo); //TODO
            	}
			...
			if ( auto *op = dyn_cast<CallInst>( &(*BI) ) )
			{
				...
				//	errs() << "cudaSetupArgument " << "\n";
					...
					//errs() << "\n";
                                ...
                                {
				//	errs() << "cudaLaunch: " << op->getNumOperands() << "\n";
	...
	virtual bool runOnBasicBlock73(Function::iterator &BB)
		...
		//		Value* size4stackHeight = builder.CreateCall(hookGridGet, builder.getInt32(2) );
			...
			//	buffer_stackHeight = builder.CreateAlloca( Type::getInt8PtrTy(C), NULL /*buffer for call stack height*/);
				...
				Value* li_d = builder.CreateLoad(Type::getInt8PtrTy(C), buffer_d);
			//	Value* li_stack = builder.CreateLoad(buffer_stack);
			//	Value* li_stackHeight = builder.CreateLoad(buffer_stackHeight);
				Value* li_h = builder.CreateLoad(Type::getInt8PtrTy(C), buffer_h);
				op -> setArgOperand(numArgs-1, li_d);
...
////	
		...
		Function* hookFuncRet;
		Function* hookFuncInit;

				hookFuncRet = cast<Function>(M.getOrInsertFunction(AF[5], VoidTy, Type::getInt8PtrTy(C)).getCallee());
		hookFuncInit = cast<Function>(M.getOrInsertFunction("InitKernel", Type::getInt8PtrTy(C),  Type::getInt8PtrTy(C)).getCallee());
                hookRet = hookFuncRet;
		...
		if(!flag1)
		{
			...
			//	errs() << op->getFunction() -> getName().str();
				...
				if (yeskernel)
				{
					...
					op -> dump();
					if (!p_stackzone) {
						errs() << "1st, Error: p_stackzone is not initialized.\n";
						// p_stackzone = builder.CreatePointerCast(ConstantPointerNull::get(Type::getInt8PtrTy(C)), Type::getInt8PtrTy(C));
						return false;
					}
					if (!hookRet)
					{
						errs() << "Error: hookRet is not initialized.\n";
						return false;
					}
					Module* M = op->getModule();
					// print the datatype of hookret
					// #include <typeinfo>
					// errs() << "hookRet type: " << typeid(hookRet).name() << "\n";
...
*/
			...
			if (!p_stackzone)
			{
				errs() << "Error: p_stackzone is not initialized.\n";
				// p_stackzone = builder.CreatePointerCast(ConstantPointerNull::get(Type::getInt8PtrTy(C)), Type::getInt8PtrTy(C));
				return false;
			}
...
//	Value* buffer_stackHeight = NULL; //for global stack height on GPU
		...
		hookFuncCudaSync = cast<Function>(M.getOrInsertFunction("cudaDeviceSynchronize", Type::getInt32Ty(C)).getCallee());
		hookFuncMeasure = cast<Function>(M.getOrInsertFunction("measureKernel", VoidTy, Type::getInt32Ty(C)).getCallee());
